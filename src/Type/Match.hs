...
checkType _ (AST.PatternTuple p _) =
  Left $ notImplemented p "PatternTuple Matching"
checkType _ (AST.PatternRecord p _) =
...
bindings p =
  error $ "unexpected pattern " ++ show p
